...
export default function Contact() {
  ...
  const inputClass =
    "mt-2 block w-full rounded-lg border px-4 py-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-300 placeholder-opacity-100 focus:placeholder-opacity-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition";
