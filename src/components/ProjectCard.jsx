export default function ProjectCard({ p = {}, onOpen = () => {} }) {
  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-800 rounded-2xl p-6 shadow-md hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col justify-between h-[380px]">
      {/* Optional Image */}
      {p?.image && (
